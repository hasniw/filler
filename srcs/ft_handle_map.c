...
/*   Updated: 2019/05/18 18:53:29 by wahasni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/filler.h"

static	ft_check_line(t_args *args, int i)
{
	int j;
...
static	ft_check_map(t_args *args)
{
	int	i;
	int	ret;
...
static	ft_check_plateau(t_args *args)
{
	int	ret;
